...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // ── Theme-switching semantic tokens (CSS custom properties) ──
        // Values are RGB triplets; supports opacity modifiers like bg-bg/80
        ...
        // ── Fixed accent tokens (same in both themes) ────────────────
        gold:           '#C9A84C',
        'gold-bright':  '#E4C86A',
        'gold-dim':     '#6B5520',
        'gold-glow':    '#C9A84C33',
        ...
        // ── Book / parchment (always parchment; campaign viewer only) ─
        parchment:      '#F4ECD8',
